        ...
        <div class="analysis-card ${statusClass}">
            ...
            <div class="result-body p-4">
                ...
                <div class="mt-4 pt-4 border-top">
                    <div class="row">
                        <div class="col-md-6">
                            <button class="btn btn-primary w-100" onclick="location.href='/dashboard'">
                                <i class="fas fa-th-large me-2"></i>View Dashboard
                            </button>
                        </div>
                        <div class="col-md-6">
                            <button class="btn btn-outline-primary w-100" onclick="document.getElementById('urlInput').value = ''; document.getElementById('result').style.display = 'none';">
                                <i class="fas fa-redo me-2"></i>Check Another URL
                            </button>
                        </div>
                    </div>
                </div>
...
checkButton.addEventListener('click', async () => {
    ...
    try {
        ...
        if (data.status === 'error') {
            ...
            // Show notification that result was saved
            showToast('✓ Result saved to dashboard history');
        }
    } catch (error) {
